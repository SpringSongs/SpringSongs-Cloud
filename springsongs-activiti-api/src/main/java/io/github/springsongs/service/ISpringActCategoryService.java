...
import io.github.springsongs.service.hytrix.SpringActCategoryServiceHystrix;
import io.github.springsongs.utils.Constant;

@FeignClient(name = "SPRINGSONGS-ACTIVITI-SERVICE",path="/SpringActCategory",fallback = SpringActCategoryServiceHystrix.class,  configuration = SecuringRequestInterceptor.class)
public interface ISpringActCategoryService {
	...
	public ResponseDTO<SpringActCategoryDTO> get( @RequestParam("id") @NotEmpty(message = "id不能为空") String id);

	@PostMapping(value = "/Create")
	public ResponseDTO<String> save(@RequestBody @Valid SpringActCategoryDTO viewEntity);

	@PutMapping(value = "/Edit")
	public ResponseDTO<String> update(@RequestBody @Valid SpringActCategoryDTO viewEntity);
