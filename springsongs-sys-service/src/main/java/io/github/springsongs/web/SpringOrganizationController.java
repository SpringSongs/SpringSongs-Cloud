...
public class SpringOrganizationController{
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "springAritlceQuery", dataType = "SpringOrganizationDTO"),
			@ApiImplicitParam(name = "page", dataType = "int"), @ApiImplicitParam(name = "size", dataType = "int") })
	@PostMapping(value = "/ListByPage")
	public ReponseResultPageDTO<SpringOrganizationDTO> listByPage(@RequestBody SpringOrganizationDTO springAritlceQuery, int page,
			int size) {
		PageInfo<SpringOrganizationDTO> lists = springOrganizationService.getAllRecordByPage(springAritlceQuery, page, size);
