...
public class BaseFileController extends BaseController {
	...
	@ApiImplicitParams({
			@ApiImplicitParam(name = "record", value = "", required = true, dataType = "BaseFileEntity"),
	...
	public R getAllRecordByPage(@RequestBody Attachment record,@RequestParam("page")  int page,@RequestParam("size")  int size) {
		R r = new R();
		try {
			r = baseFileService.getAllRecordByPage(record, page, size);
		} catch (Exception ex) {
			r.put("code", 500);
			r.put("msg", "系统错误");
		}
	...
	public R deleteByPrimaryKey(@RequestParam("id") String id) {
		R r = new R();
		try {
			baseFileService.deleteByPrimaryKey(id);
			r.put("code", 200);
			r.put("msg", "删除成功");
		} catch (Exception ex) {
			r.put("code", 500);
	...
	public R insert(@RequestBody Attachment record) {
		R r = new R();
		try {
			baseFileService.insert(record);
			r.put("code", 200);
			r.put("msg", "删除成功");
		} catch (Exception ex) {
			r.put("code", 500);
	...
	public R selectByPrimaryKey(@RequestParam("id") String id) {
		R r = new R();
		try {
			Attachment entity = baseFileService.selectByPrimaryKey(id);
			r.put("code", 200);
			r.put("data", entity);
			r.put("msg", "删除成功");
		} catch (Exception ex) {
	...
	public R updateByPrimaryKey(@RequestBody Attachment record) {
		R r = new R();
		try {
			baseFileService.updateByPrimaryKey(record);
			r.put("code", 200);
			r.put("msg", "删除成功");
		} catch (Exception ex) {
			r.put("code", 500);
