...
public class BaseRoleController extends BaseController {
	...
	@ApiImplicitParams({ @ApiImplicitParam(name = "record", value = "", required = true, dataType = "BaseRoleEntity"),
	...
	public R getAllRecordByPage(@RequestBody Role record, @RequestParam("page") int page,
			@RequestParam("size") int size) {
		R r = new R();
		try {
			r = baseRoleService.getAllRecordByPage(record, page, size);
		} catch (Exception ex) {
			r.put("code", 500);
			r.put("msg", "系统错误");
		}
	...
	public R deleteByPrimaryKey(@RequestParam("id") String id) {
		R r = new R();
		try {
			baseRoleService.deleteByPrimaryKey(id);
			r.put("code", 200);
			r.put("msg", "删除成功");
		} catch (Exception ex) {
			r.put("code", 500);
	...
	@ApiImplicitParams({
			@ApiImplicitParam(name = "record", value = "", required = true, dataType = "BaseRoleEntity"), })
	@ApiResponses({ @ApiResponse(code = 200, message = "Successful — 请求已完成"),
			@ApiResponse(code = 400, message = "请求中有语法问题，或不能满足请求"), @ApiResponse(code = 401, message = "未授权客户机访问数据"),
			@ApiResponse(code = 404, message = "服务器找不到给定的资源；文档不存在"), @ApiResponse(code = 500, message = "服务器不能完成请求") })
	@PostMapping(value = "/Insert")
	public R insert(@RequestBody Role record) {
		R r = new R();
		try {
			baseRoleService.insert(record);
			r.put("code", 200);
			r.put("msg", "保存成功");
		} catch (Exception ex) {
			r.put("code", 500);
	...
	public R selectByPrimaryKey(@RequestParam("id") String id) {
		R r = new R();
		try {
			Role entity = baseRoleService.selectByPrimaryKey(id);
			r.put("code", 200);
			r.put("data", entity);
			r.put("msg", "获取成功");
		} catch (Exception ex) {
	...
	public R updateByPrimaryKey(@RequestBody Role record) {
		R r = new R();
		try {
			Role entity = baseRoleService.selectByPrimaryKey(record.getId());
			if (null == entity) {
				...
				baseRoleService.updateByPrimaryKey(record);
				r.put("code", 200);
				r.put("msg", "删除成功");
			}
		} catch (Exception ex) {
	...
	@ApiOperation(value = "查询用户所有角色", notes = "取单个实体", response = String.class)
	@ApiImplicitParams({ @ApiImplicitParam(name = "userId", value = "", required = true, dataType = "String"), })
	@ApiResponses({ @ApiResponse(code = 200, message = "Successful — 请求已完成"),
			@ApiResponse(code = 400, message = "请求中有语法问题，或不能满足请求"), @ApiResponse(code = 401, message = "未授权客户机访问数据"),
			@ApiResponse(code = 404, message = "服务器找不到给定的资源；文档不存在"), @ApiResponse(code = 500, message = "服务器不能完成请求") })
	@PostMapping(value = "/GetRolesByUserId")
	public R getRolesByUserId(@RequestParam("userId") String userId) {
		R r = new R();
		try {
			List<Role> BaseRoleEntityList = baseRoleService.getRolesByUserId(userId);
			r.put("code", 200);
			r.put("data", BaseRoleEntityList);
			r.put("msg", "删除成功");
		} catch (Exception ex) {
			r.put("code", 500);
			r.put("msg", "系统错误");
	...
	@ApiOperation(value = "查询角色", notes = "查询角色", response = String.class)
	@ApiImplicitParams({ @ApiImplicitParam(name = "userId", value = "", required = true, dataType = "String"),
			@ApiImplicitParam(name = "page", value = "", required = true, dataType = "int"),
			@ApiImplicitParam(name = "limit", value = "", required = true, dataType = "int") })
	@ApiResponses({ @ApiResponse(code = 200, message = "Successful — 请求已完成"),
			@ApiResponse(code = 400, message = "请求中有语法问题，或不能满足请求"), @ApiResponse(code = 401, message = "未授权客户机访问数据"),
			@ApiResponse(code = 404, message = "服务器找不到给定的资源；文档不存在"), @ApiResponse(code = 500, message = "服务器不能完成请求") })
	@PostMapping(value = "ListRolesByUserId")
	public R listRolesByUserId(@RequestParam(value = "userId", required = true) String userId,
	...
	@ApiOperation(value = "分配角色", notes = "分配角色", response = String.class)
	@ApiImplicitParams({
			@ApiImplicitParam(name = "baseUserRoleEntityList", value = "", required = true, dataType = "List<BaseUserRoleEntity>"),
			@ApiImplicitParam(name = "userId", value = "", required = true, dataType = "String") })
	@ApiResponses({ @ApiResponse(code = 200, message = "Successful — 请求已完成"),
			@ApiResponse(code = 400, message = "请求中有语法问题，或不能满足请求"), @ApiResponse(code = 401, message = "未授权客户机访问数据"),
			@ApiResponse(code = 404, message = "服务器找不到给定的资源；文档不存在"), @ApiResponse(code = 500, message = "服务器不能完成请求") })
	@RequestMapping(value = "/SaveUserToRole", method = RequestMethod.POST)
