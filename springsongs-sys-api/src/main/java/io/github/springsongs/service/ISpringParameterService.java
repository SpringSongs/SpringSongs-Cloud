...
@FeignClient(name = "SPRINGSONGS-SYS-SERVICE", path = "/SpringParameter", fallback =SpringParameterServiceHystrix.class, configuration = SecuringRequestInterceptor.class)
