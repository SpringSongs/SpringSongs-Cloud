...
public class SpringAttachmentCategoryServiceHystrix implements ISpringAttachmentCategoryService {
	...
	@Override
	public ResponseDTO<SpringAttachmentCategoryDTO> get(String id) {
		return ResponseDTO.successed(ResultCode.SERCIE_BUSING);
	}

	@Override
	public ResponseDTO<String> save( SpringAttachmentCategoryDTO viewEntity) {
		return ResponseDTO.successed(ResultCode.SERCIE_BUSING);
	}

	@Override
	public ResponseDTO<String> update(SpringAttachmentCategoryDTO viewEntity) {
		return ResponseDTO.successed(ResultCode.SERCIE_BUSING);
	}
