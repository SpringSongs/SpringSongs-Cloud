...
public class SpringSiteNoticeController{
	...
	public ReponseResultPageDTO<SpringSiteNoticeDTO> listByPage(@RequestBody SpringSiteNoticeDTO searchQuery, int page,
			int size) {
		ReponseResultPageDTO<SpringSiteNoticeDTO> reponseResultPageDTO =SpringSiteNoticeService.listByPage(searchQuery, page, size);
	...
	public ResponseDTO<SpringSiteNoticeDTO> get(@NotEmpty(message = "id不能为空") String id) {
		ResponseDTO<SpringSiteNoticeDTO> responseDTO = SpringSiteNoticeService.get(id);
		return responseDTO;
	}
	...
	public ResponseDTO<String> save(@RequestBody @Valid SpringSiteNoticeDTO viewEntity, HttpServletRequest request) {
		ResponseDTO<String> responseDTO = SpringSiteNoticeService.save(viewEntity);
	...
	public ResponseDTO<String> update(@RequestBody @Valid SpringSiteNoticeDTO viewEntity, HttpServletRequest request) {
		ResponseDTO<String> responseDTO = SpringSiteNoticeService.update(viewEntity);
		return responseDTO;
	}
	...
	public ResponseDTO<String> setDeleted(@RequestParam(value = "ids", required = true) List<String> ids) {
		ResponseDTO<String> responseDTO = SpringSiteNoticeService.setDeleted(ids);
		return responseDTO;
	}
